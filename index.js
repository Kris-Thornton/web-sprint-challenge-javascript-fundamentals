...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/* NestedFunction() is a function within or internal to myFunction(), therefore when invoking nestedFunction which logs internal it will look for the varibale internal in its own scope and if not found, reach out to the next scope which is myFunction(); */
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    const animalNameLower = zooAnimals.map(function(item) {
      return item.animal_name.toLowerCase();
    });
    return animalNameLower
  }
  ...
  */
  ...
  function lowPopulationAnimals(arr){
    let newArry = arr.filter(function(index) {
  ...
  */
  ...
  function USApop(arry){
    const populationTotal = arry.reduce(function(accumulator, item){
